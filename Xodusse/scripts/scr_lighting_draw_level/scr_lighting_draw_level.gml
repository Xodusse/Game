/// @description scr_lighting_draw_level(level map,color sheet,normal sheet,property sheet,x,y)
/// @function scr_lighting_draw_level
/// @param level map
/// @param color sheet
/// @param normal sheet
/// @param property sheet
/// @param x
/// @param y
// © 2017 - Jon Harvey
...
draw_vertex_texture(-10240,-10240,0,0);
draw_vertex_texture(10240,-10240,10,0);
draw_vertex_texture(-10240,10240,0,10);
draw_vertex_texture(10240,10240,10,10);
draw_primitive_end();
