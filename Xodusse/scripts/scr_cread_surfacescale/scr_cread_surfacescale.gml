...
//Check if 0.5 (Decimal):
if (string_pos("0.5", str_surfacescale)){
...
else if (string_pos("1", str_surfacescale)) || (string_pos("2", str_surfacescale)) || (string_pos("4", str_surfacescale)){
