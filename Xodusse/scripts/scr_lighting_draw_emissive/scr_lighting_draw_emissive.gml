/// @description scr_lighting_draw_emissive(emissive sprite,subimg,x,y,xscale,yscale,rot,color,alpha)
/// @function scr_lighting_draw_emissive
/// @param emissive sprite
/// @param subimg
/// @param x
/// @param y
/// @param xscale
